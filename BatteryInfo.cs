...
namespace Serial_Communication
{
    internal class BatteryInfo
    {
        ...
        // 수신된 데이터를 저장할 변수들
       public static byte receivedSTX;
        public static byte receivedCmd;
        public static ushort receivedLength;
        public static ushort receivedTotalVoltage;
        public static short receivedCurrent;
        public static byte receivedSOC;
        public static ushort[] receivedCV = new ushort[18];//CellVoltage 1~16
        public static ushort[] receivedBL = new ushort[3];//Battery Level 1~3 status
        public static byte[] receivedEX = { 0x2, 0x5, 0x2B, 0x0, 0x8A, 0x20, 0x0, 0x0, 0x0, 0xCE, 0x12, 0xD4, 0x12, 0xD4, 0x12, 0xD4, 0x12, 0xD4, 0x12, 0xD3, 0x12, 0xD4, 0x12, 0xD3, 0x12, 0xD1, 0x12, 0xD3, 0x12, 0xD3, 0x12, 0xD3, 0x12, 0xD3, 0x12, 0xD3, 0x12, 0xD3, 0x12, 0xCB, 0x12, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x42, 0x36, 0x3 };
        public static ushort receivedChecksum;
        public static byte receivedETX;
